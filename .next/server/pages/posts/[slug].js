...
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3731);
...
/* harmony import */ var _lib_constants__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(9953);
...
const Post = ({ post , morePosts , preview , allPosts  })=>{
    (0,react__WEBPACK_IMPORTED_MODULE_12__.useEffect)(()=>{
        let blogPosts = [];
        if (localStorage.getItem("viewedPost")) {
...
async function getStaticProps({ params  }) {
    ...
    const allPosts = (0,_lib_api__WEBPACK_IMPORTED_MODULE_8__/* .getAllPosts */ .Bd)([
        "title",
        "date",
        "slug",
        "author",
...
var __webpack_exports__ = __webpack_require__.X(0, [952,664,979], () => (__webpack_exec__(8542)));
